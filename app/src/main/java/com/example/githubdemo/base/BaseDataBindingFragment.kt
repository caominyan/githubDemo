...
abstract class BaseDataBindingFragment(@LayoutRes contentLayoutId: Int) : Fragment(contentLayoutId) {
    ...
    inline fun <reified T : ViewBinding> BaseDataBindingFragment.binding() =
